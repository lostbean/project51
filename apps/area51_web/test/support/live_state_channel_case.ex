defmodule Area51Web.LiveStateChannelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      use Area51Web.ChannelCase

      # Import LiveStateTestUtils
      import Area51Web.LiveStateTestUtils
  ...
  # When we use Area51Web.ChannelCase above, it brings in all the setup
end
