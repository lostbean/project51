defmodule Area51.Data.GameSession do
  ...
  schema "game_sessions" do
    ...
    has_many :clues, Area51.Data.Clue
    has_many :player_contributions, Area51.Data.PlayerContribution
  ...
  def fetch_or_create_new_game_session(id, narrative_params) when is_map(narrative_params) do
    case Repo.get_by(Area51.Data.GameSession, id: id) do
      nil ->
        # Create a new session with the provided narrative parameters
        Repo.insert!(%Area51.Data.GameSession{
  ...
  def fetch_or_create_new_game_session(id, new_narrative) when is_binary(new_narrative) do
    Repo.get_by(Area51.Data.GameSession, id: id) ||
      Repo.insert!(%Area51.Data.GameSession{narrative: new_narrative})
  end

  def update_narrative(id, narrative) do
    game_session = Repo.get_by!(Area51.Data.GameSession, id: id)
  ...
  def list_game_sessions do
    Repo.all(Area51.Data.GameSession)
  end
  ...
  def get_game_session(id) do
    Repo.get(Area51.Data.GameSession, id)
  end
  ...
  def data_to_core(%Area51.Data.GameSession{} = game_session) do
    %Area51.Core.GameSession{
